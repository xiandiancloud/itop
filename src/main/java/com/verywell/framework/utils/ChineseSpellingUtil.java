...
public class ChineseSpellingUtil
{
	...
	{
		return getFullSpell(cnStr).split(" ")[0];
	}
	...
	public static void main(String[] args)
	{
		...
		try
		{
			str = new String("孙莲莲".getBytes(), "UTF8");
		}
		catch (UnsupportedEncodingException ex)
		{
		}
		System.out.println("Spell=" + ChineseSpellingUtil.getFullSpell(str));
		System.out.println("Spell=" + ChineseSpellingUtil.getFirstSpell(str));
	}
