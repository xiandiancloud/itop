...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mianbaoxie">
			当前位置：<a href="#1">设备管理</a> > <a href="${ctx}/devClassInfoMgr">设备类型管理</a>> 属性管理 >新增
		</div>
		<form:form id="mainForm" name="mainForm" method="POST" action="${ctx}/devAttributesMgr/save"  modelAttribute="resultObject">
		...
		<div class="table_div">
			<table width="100%" class="table_border">
				<tr>
					...
					<input type="hidden" name="devClassId" value="${classInfo.devClassId}"/>
					<input type="hidden" name="attrStatus" value="1"/>
				</tr>
				<tr>
					...
					<td>
						<form:input path="attrKey" cssClass="form_input {required:true,maxlength:25,alphanumeric:true}" size="20"/>
					</td>
				</tr>
				<tr>
					<td class="title" width="100">
				...
				<tr>
					<td align="center" valign="middle" colspan="2">
						...
						<input type="button" class="form_botton" value="返  回" onclick="window.location='${ctx}/devClassInfoMgr/view/${classInfo.devClassId}'" />
					</td>					
				</tr>
			</table>	
			</div>
