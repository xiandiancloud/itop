...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mianbaoxie">
			当前位置：<a href="#1">设备管理</a> > <a href="${ctx}/devClassGroupInfoMgr">设备类型分组管理</a>  > 编辑
		</div>
		<form:form id="mainForm" name="mainForm" method="POST" action="${ctx}/devClassGroupInfoMgr/update"  modelAttribute="resultObject">
			...
			<table width="100%" class="table_border">
				...
				<tr>
					<td class="title" width="100">
						<font color="red">*&nbsp;</font>属性编号
					</td>
					<td>
						<form:hidden path="groupId"/>
						<input name="groupId" class="form_input {required:true,maxlength:10,digits:true}" disabled="false" value="${resultObject.groupId}"/>
					</td>
				</tr>
				<tr>
					<td class="title" width="100">
